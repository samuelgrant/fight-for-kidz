...
<div style="background-color: black;">
	...
	<div class="container pt-5">
		...
		<div class="row bouts-row">
			...
			@foreach($event->bouts as $bout) @if($bout->contendersSet()) {{-- Only use bouts that have contenders set, this prevents
			crash --}}
			...
			<div class="col-lg-6 bout-column">
				...
				<div class="bout-card">
					<div class="bout-header">
						<h2>BOUT {{++$i}}</h2>
						{{--
						<p class="sponsored-by">sponsored by</p> --}} @if($bout->sponsor)
					...
					<div class="contender-card contender-card-red">
						<div class="contender-card-inner">
							...
							<div class="bout-btn bout-btn-red bio-view-button" data-toggle="modal" data-target="#bio-modal" data-contenderId="{{$bout->red_contender->id}}">View Bio</div>
					...
					<div class="contender-card contender-card-blue">
						<div class="contender-card-inner">
							...
							<div class="contender-name">
								...
								<div class="bout-btn bout-btn-blue bio-view-button" data-toggle="modal" data-target="#bio-modal" data-contenderId="{{$bout->blue_contender->id}}">View Bio</div>
					...
					<div class="modal-body">
						...
						<div id="dynamic-content" style="color:black;">
							...
							<div class="text-center">
								...
								<hr>
								<iframe width="560" height="315" id="bio-vid" src="" frameborder="0" allow="autoplay; encrypted-media;" allowfullscreen></iframe>
