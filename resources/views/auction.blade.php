                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="dropdown">
                        ...
                        <ul id="dropdown2" class="dropdown-menu">
                            ...
                            <li>
                                <a class="js-scroll-trigger" href="auction.html#merchandise">
                                    <p>Merchandise</p>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="js-scroll-trigger" href="index.html#signup">
                                    <p>Apply</p>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="index.html#signup">
                            <p>Contact Us</p>
                        </a>
                    </li>
                </ul>
