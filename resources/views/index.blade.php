...
@section('content')
	...
	<div style="background-color: black;">
		<section id="about" class="upcoming-section pt-1">
						...
						<div class="col-lg-8 col-sm-12">								
							...
							<div style="display: table; height: 100%;">
								<div style="display: table-cell;">
									<img src="storage/images/mainPagePhoto.jpg?{{filemtime(storage_path('app/public/images/mainPagePhoto.jpg'))}}" class="img-fluid mt-4 mb-5" alt="Fight for Kidz 2016 cheque" />
								</div>
							</div>
						</div>
						<div class="col-lg-4 d-md-block">
							<div class="mx-auto mt-3 mb-5" style="width:340px">
								<div id="fb-root"></div>
				...
				<form method="post" action="{{route('subscribe')}}" class="justify-content-center">
					<div class="row">
						...
						<div class="col-md-6 offset-md-3">         
							<button class="btn btn-success btn-block my-3" id="subscribeBtn" type="submit"><i class="far fa-newspaper"></i> Sign up for updates</button>
							{!! app('captcha')->render(); !!}      
						</div>
					</div>
					@csrf
