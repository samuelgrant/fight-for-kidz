@extends('layouts.app') 
@section('content')
<div id="merchandise" class="container mb-5" style="background-color: rgba(0,0,0,0.7); border-radius: 5px;">
    <div class="heading-container pt-3 my-3">
        <h1 class="text-center my-2">Merchandise</h1>
